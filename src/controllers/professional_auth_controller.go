...
func NewProfessionalAuthController(authService *services.AuthService) *ProfessionalAuthController {
	return &ProfessionalAuthController{
		AuthService: authService,
	}
}

// Register manipula o registro de novos profissionais
// @Summary Registra um novo profissional
// @Description Cria um novo usuário com o perfil de profissional e estabelecimento associado
// @Tags professional-auth
// @Accept json
// @Produce json
// @Param request body services.RegisterRequest true "Dados do registro"
...
// @Router /api/v1/professional/auth/register [post]
func (c *ProfessionalAuthController) Register(ctx *gin.Context) {
	...
	// Forçamos o role para professional
	req.Role = models.UserRoleProfessional
...
// Login manipula o login de profissionais
// @Summary Login de profissional
// @Description Autentica um profissional e retorna tokens de acesso
// @Tags professional-auth
// @Accept json
// @Produce json
...
// @Failure 403 {object} ErrorResponse "Usuário bloqueado ou não é um profissional"
// @Failure 422 {object} ErrorResponse "Validação falhou"
// @Failure 500 {object} ErrorResponse "Erro interno do servidor"
// @Router /api/v1/professional/auth/login [post]
func (c *ProfessionalAuthController) Login(ctx *gin.Context) {
	...
	// Verificamos se o usuário é profissional
	if user.Role != models.UserRoleProfessional && user.Role != models.UserRoleStaff && user.Role != models.UserRoleAdmin {
		utils.SendErrorResponse(ctx, http.StatusForbidden, "INVALID_ROLE", "Este usuário não tem acesso ao painel de profissional", nil)
		return
	}
...
// @Failure 500 {object} ErrorResponse "Erro interno do servidor"
// @Router /api/v1/professional/auth/refresh [post]
...
// @Failure 500 {object} ErrorResponse "Erro interno do servidor"
// @Router /api/v1/professional/auth/forgot-password/email [post]
...
// @Failure 429 {object} ErrorResponse "Muitas requisições"
// @Failure 500 {object} ErrorResponse "Erro interno do servidor"
// @Router /api/v1/professional/auth/forgot-password/sms [post]
...
// @Failure 429 {object} ErrorResponse "Muitas requisições"
// @Failure 500 {object} ErrorResponse "Erro interno do servidor"
// @Router /api/v1/professional/auth/forgot-password/whatsapp [post]
...
// @Failure 500 {object} ErrorResponse "Erro interno do servidor"
// @Router /api/v1/professional/auth/reset-password/validate/{token} [get]
...
// @Failure 422 {object} ErrorResponse "Validação falhou"
// @Failure 500 {object} ErrorResponse "Erro interno do servidor"
// @Router /api/v1/professional/auth/reset-password [post]
